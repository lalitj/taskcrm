<template>
  <div>
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('companys')">
        <icon name="office-building" class="w-4 h-4 mr-2" :class="isUrl('companys') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('companys') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Company</div>
      </inertia-link>
    </div>
    <div class="mb-4">
